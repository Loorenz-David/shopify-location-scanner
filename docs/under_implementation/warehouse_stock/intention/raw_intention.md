...
> - 2026-09-02 — **Re-stamped RATIFIED by the product owner (David)**, confirming §27 against the six-point surface above — including, explicitly, the quantity-18 case: a definition inside the normal band but below its threshold reports a non-zero gap, and that is the fill reading working, not a defect. The gate is closed; prompts may compile again.
>
