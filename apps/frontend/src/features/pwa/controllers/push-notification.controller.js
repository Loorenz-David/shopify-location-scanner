import { canUsePushNotifications, vapidKeyToUint8Array, } from "../domain/push-notification.domain";
...
export async function subscribeToPushController(vapidPublicKey) {
...
export async function unsubscribeFromPushController() {
    if (!canUsePushNotifications())
        return;
