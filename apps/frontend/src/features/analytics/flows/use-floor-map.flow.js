...
import { selectFloorPlans, selectSelectedFloorPlanId, useFloorPlanStore, } from "../stores/floor-plan.store";
...
export function useFloorMapFlow(containerRef, resizeKey) {
    ...
    useEffect(() => {
        const shouldWaitForFloorSelection = floorPlans.length > 0 && selectedFloorPlanId === null;
