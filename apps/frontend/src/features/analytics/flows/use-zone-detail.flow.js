...
import { selectAnalyticsSelectedZone, selectAnalyticsSelectedZoneLevel, selectAnalyticsZoneDateRange, useAnalyticsStore, } from "../stores/analytics.store";
export function useZoneDetailFlow() {
    ...
    const setLoadingZoneDetail = useAnalyticsStore((state) => state.setLoadingZoneDetail);
