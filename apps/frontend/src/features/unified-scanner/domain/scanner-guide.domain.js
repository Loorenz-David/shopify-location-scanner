...
export function getScannerGuideRect({ viewportWidth, viewportHeight, paddingPx = 0, }) {
    const shortestEdge = Math.min(viewportWidth, viewportHeight);
    const guideBaseSize = clamp(shortestEdge * SCANNER_GUIDE_VIEWPORT_SIZE_RATIO, SCANNER_GUIDE_MIN_SIZE_PX, SCANNER_GUIDE_MAX_SIZE_PX);
