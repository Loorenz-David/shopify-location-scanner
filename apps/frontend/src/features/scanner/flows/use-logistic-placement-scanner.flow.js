...
import { attachDecodeSession, CAMERA_REGION_IDS, } from "../../unified-scanner/domain/camera-session.manager";
export const LOGISTIC_PLACEMENT_REGION_ID = CAMERA_REGION_IDS["logistic-placement"];
export function useLogisticPlacementScannerFlow(onDecode) {
    ...
    useEffect(() => {
        ...
        const detach = attachDecodeSession("logistic-placement", (value) => {
