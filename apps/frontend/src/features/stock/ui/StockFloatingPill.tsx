...
export function StockFloatingPill({ label, onPress, disabled = false }: StockFloatingPillProps) {
  return (
    <>
      ...
      <button
        type="button"
        className="fixed left-1/2 z-30 inline-flex h-[52px] -translate-x-1/2 items-center gap-2 whitespace-nowrap rounded-[26px] bg-[var(--stock-primary)] px-6 text-[14px] font-semibold text-white shadow-[var(--stock-cta-shadow)] transition active:scale-[0.98] disabled:opacity-60"
