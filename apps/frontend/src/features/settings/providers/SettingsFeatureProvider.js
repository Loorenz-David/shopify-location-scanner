...
import { selectBootstrapLastSyncedAt, useBootstrapStore, } from "../../bootstrap/stores/bootstrap.store";
...
import { selectSettingsProfile, selectSettingsProfileError, selectSettingsProfileLoading, useSettingsStore, } from "../stores/settings.store";
export function SettingsFeatureProvider({ onLogout, children, }) {
    ...
    return (_jsx(SettingsPageProvider, { value: contextValue, children: children }));
}
