 ...
 */
export function getImageTransformUrl(imageUrl, resolution) {
    if (!imageUrl)
        return imageUrl;
 ...
 */
function applyShopifyTransform(imageUrl, width, resolution) {
 ...
 */
export function getFullscreenImageUrl(imageUrl) {
