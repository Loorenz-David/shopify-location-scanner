...
const parsePaidDate = (payload) => {
    const rawDate = payload.processed_at ?? payload.updated_at ?? payload.created_at;
    if (!rawDate) {
        return new Date();
    }
...
//# sourceMappingURL=handle-orders-paid-webhook.command.js.map