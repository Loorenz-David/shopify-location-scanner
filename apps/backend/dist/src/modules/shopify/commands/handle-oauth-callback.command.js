import { ConflictError, ForbiddenError, UnauthorizedError, ValidationError, } from "../../../shared/errors/http-errors.js";
...
export const handleOauthCallbackCommand = async (input) => {
    ...
    if (user.shopId) {
        ...
        if (linked && linked.shopDomain !== input.query.shop) {
            throw new ConflictError("User is already linked to a different Shopify store");
        }
    }
...
//# sourceMappingURL=handle-oauth-callback.command.js.map