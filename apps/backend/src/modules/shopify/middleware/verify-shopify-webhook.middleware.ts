...
const createVerifyShopifyWebhookMiddleware = (expectedTopic: string) => {
  return async (
    req: Request,
    _res: Response,
    next: NextFunction,
...
export const verifyProductsUpdateWebhookMiddleware =
  createVerifyShopifyWebhookMiddleware("products/update");
