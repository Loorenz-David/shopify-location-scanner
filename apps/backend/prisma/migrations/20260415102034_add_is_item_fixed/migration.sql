...
INSERT INTO "new_ScanHistory" ("createdAt", "fixItem", "id", "intention", "isSold", "itemBarcode", "itemCategory", "itemDepth", "itemHeight", "itemImageUrl", "itemSku", "itemTitle", "itemType", "itemWidth", "lastLogisticEventType", "lastModifiedAt", "lastSoldChannel", "latestLocation", "logisticLocationId", "logisticsCompletedAt", "orderId", "productId", "scheduledDate", "shopId", "updatedAt", "userId", "username", "volume") SELECT "createdAt", "fixItem", "id", "intention", "isSold", "itemBarcode", "itemCategory", "itemDepth", "itemHeight", "itemImageUrl", "itemSku", "itemTitle", "itemType", "itemWidth", "lastLogisticEventType", "lastModifiedAt", "lastSoldChannel", "latestLocation", "logisticLocationId", "logisticsCompletedAt", "orderId", "productId", "scheduledDate", "shopId", "updatedAt", "userId", "username", "volume" FROM "ScanHistory";
